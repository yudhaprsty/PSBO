  ...
  <!-- <div class="content-top "> -->
  	<div class="container ">
  		<div class="tab-head ">
                ...
                @if($product->varian == "Seeds")
  							<div class="col-md-3 m-wthree">
  								<div class="col-m">
  									<a href="/produk/{{$product->id}}" data-toggle="modal" data-target="#myModal1" class="offer-img">
  										<img src="/images/produk/{{ $product -> gambar_produk }}" class="img-responsive" alt="" style="width: 200px; height: 200px;">
